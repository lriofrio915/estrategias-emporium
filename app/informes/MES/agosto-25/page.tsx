...
export default function InformeAgosto25MQNPage() {
    ...
    const winRateConfig: ChartConfiguration<"doughnut", number[], string> = {
      ...
      options: {
        ...
        plugins: {
          ...
          title: {
            display: true,
            text: "Tasa de Éxito: 25%", // 1 ganadora de 4 trades
            font: {
              size: 20,
              weight: "bold",
              family: "Inter",
      ...
      datasets: [
        {
          ...
          data: [1, 2], // Racha positiva más larga: 1; Racha negativa más larga: 2
          backgroundColor: [
            "rgba(44, 165, 141, 0.7)",
            "rgba(217, 83, 79, 0.7)",
          ],
    ...
    <div className="container mx-auto p-4 md:p-8 max-w-7xl pt-20">
      <header className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-extrabold text-[#0A2342] mb-2">
          Micro E-mini S&P 500: Análisis Operativo de Agosto 2025
        </h1>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-12">
        <div className="kpi-card text-center">
          ...
          <p className="text-6xl font-extrabold text-[#0A2342]">4</p>
        </div>
        ...
        <div className="kpi-card border-t-4 border-[#D9534F] text-center">
          ...
          <p className="text-6xl font-extrabold text-[#D9534F]">3</p>
        </div>
      </section>
      ...
      <main className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="text-center text-gray-600 mb-8">
            El mes de agosto fue un ejercicio de disciplina y paciencia,
            enfrentando una racha de pérdidas que pone a prueba la estrategia.
            Mantener la calma y el estricto apego al plan es crucial para
            superar estos periodos de mercado errático y esperar el momento
            oportuno.
          </p>
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <Image
                src="https://i.ibb.co/1fHzfB2S/05-08-2025-stop.png"
                alt="Operación de MES del 05 de agosto, resultado STOP"
                width={800}
                height={600}
            ...
            <div>
              <h3 className="font-bold text-lg mb-2">
                Operación 2: Miércoles 06-08 - TARGET
              </h3>
              <Image
                src="https://i.ibb.co/Mx9dLPR1/06-08-2025-target.png"
                alt="Operación de MES del 06 de agosto, resultado TARGET"
                width={800}
                height={600}
                className="w-full h-auto rounded-lg shadow-md mb-4"
              />
            ...
            <div>
              <h3 className="font-bold text-lg mb-2">
                Operación 3: Miércoles 20-08 - STOP
              </h3>
              <Image
                src="https://i.ibb.co/mrD7HY81/20-08-2025-stop.png"
                alt="Operación de MES del 20 de agosto, resultado STOP"
                width={800}
                height={600}
                className="w-full h-auto rounded-lg shadow-md mb-4"
              />
            ...
            <div>
              <h3 className="font-bold text-lg mb-2">
                Operación 4: Viernes 22-08 - STOP
              </h3>
              <Image
                src="https://i.ibb.co/DP2rXcTZ/22-08-2025-stop.png"
                alt="Operación de MES del 22 de agosto, resultado STOP"
                width={800}
                height={600}
                className="w-full h-auto rounded-lg shadow-md mb-4"
              />
