// app/informes/MNQ/page.tsx

import Link from 'next/link';

export const metadata = {
  title: "Informes Operativos MNQ - Pulso Bursátil", // Título más específico
  description: "Accede a los informes de trading operativos mensuales de la Estrategia Nasdaq (MNQ) por Emporium Quality Funds.", // Descripción más específica
};

// Datos de los informes para 2025 de la Estrategia MNQ
const reports2025 = [
  { id: 1, month: 'Enero', successRate: 'N/A', link: '/informes/MNQ/enero-25' },
  { id: 2, month: 'Febrero', successRate: 'N/A', link: '/informes/MNQ/febrero-25' },
  { id: 3, month: 'Marzo', successRate: 'N/A', link: '/informes/MNQ/marzo-25' },
  { id: 4, month: 'Abril', successRate: 'N/A', link: '/informes/MNQ/abril-25' },
  { id: 5, month: 'Mayo', successRate: 'N/A', link: '/informes/MNQ/mayo-25' },
  { id: 6, month: 'Junio', successRate: '75%', link: '/informes/MNQ/junio-25' }, 
  { id: 7, month: 'Julio', successRate: '50%', link: '/informes/MNQ/julio-25' }, 
  { id: 8, month: 'Agosto', successRate: '25%', link: '/informes/MNQ/agosto-25' },
  { id: 9, month: 'Septiembre', successRate: 'N/A', link: '/informes/MNQ/septiembre-25' },
  { id: 10, month: 'Octubre', successRate: 'N/A', link: '/informes/MNQ/octubre-25' },
  { id: 11, month: 'Noviembre', successRate: 'N/A', link: '/informes/MNQ/noviembre-25' },
  { id: 12, month: 'Diciembre', successRate: 'N/A', link: '/informes/MNQ/diciembre-25' },
];
    ...
    <div className="container mx-auto p-4 md:p-8 max-w-7xl pt-20"> {/* Añadimos pt-20 para el navbar fijo */}
      <header className="text-center mb-12 mt-8">
        <h1 className="text-4xl md:text-5xl font-extrabold text-[#0A2342] mb-4">
          Informes Operativos de Trading MNQ
        </h1>
        <p className="text-lg md:text-xl text-[#849E8F]">
          Accede a los análisis de rendimiento mensuales de la Estrategia Nasdaq (MNQ).
        </p>
      </header>
