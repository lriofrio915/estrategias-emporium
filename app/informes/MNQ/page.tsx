...
export const metadata = {
  title: "Informes Operativos MNQ - Pulso Bursátil", // Título específico para MNQ
  description:
    "Accede a los informes de trading operativos mensuales de la Estrategia Micro E-mini Nasdaq (MNQ) basada en Volumen por Emporium Quality Funds.", // Descripción específica
};
...
const reports2025 = [
  ...
  { id: 6, month: "Junio", successRate: "N/A", link: "/informes/MNQ/junio-25" },
  { id: 7, month: "Julio", successRate: "N/A", link: "/informes/MNQ/julio-25" },
  {
    id: 8,
    month: "Agosto",
    successRate: "N/A",
    link: "/informes/MNQ/agosto-25",
  },
  {
    id: 9,
    month: "Septiembre",
    successRate: "N/A",
    link: "/informes/MNQ/septiembre-25",
  },
  {
    id: 10,
    month: "Octubre",
    successRate: "N/A",
    link: "/informes/MNQ/octubre-25",
  },
  {
    id: 11,
    month: "Noviembre",
    successRate: "N/A",
    link: "/informes/MNQ/noviembre-25",
  },
  {
    id: 12,
    month: "Diciembre",
    successRate: "N/A",
    link: "/informes/MNQ/diciembre-25",
  },
];

export default function InformesMNQPage() {
  return (
    <div className="container mx-auto p-4 md:p-8 max-w-7xl pt-20">
      <header className="text-center mb-12 mt-8">
        ...
        <p className="text-lg md:text-xl text-[#849E8F]">
          Accede a los análisis de rendimiento mensuales de la Estrategia Micro
          E-mini Nasdaq (MNQ) basada en Volumen.
        </p>
      </header>
      ...
      <section className="bg-white rounded-lg shadow-xl p-6 md:p-8 mb-12">
        <h2 className="text-3xl font-bold text-center text-[#0A2342] mb-6">
          Informes de Desempeño 2025 (Estrategia MNQ)
        </h2>
